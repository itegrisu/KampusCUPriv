namespace Application.Features.DefinitionManagementFeatures.Districts.Constants;
...
public static class DistrictsBusinessMessages
{
    ...
    public const string SuccessCreatedDistrictMessage = "District Successfully Created";
    public const string SuccessDeletedDistrictMessage = "District Successfully Deleted";
    public const string SuccessUpdatedDistrictMessage = "District Successfully Updated";
