namespace Application.Features.PortalManagementFeatures.PortalTexts.Constants;

public static class PortalTextsBusinessMessages
{
    public const string SectionName = "PortalText";

    public const string PortalTextNotExists = "PortalText Not Exists";
    public const string ProcessCompleted = "Process Completed";

    public const string SuccessCreatedPortalTextMessage = "PortalText Successfully Created";
    public const string SuccessDeletedPortalTextMessage = "PortalText Successfully Deleted";
    public const string SuccessUpdatedPortalTextMessage = "PortalText Successfully Updated";
