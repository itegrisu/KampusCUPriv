...
public class CreateLogAuthorizationErrorCommandValidator : AbstractValidator<CreateLogAuthorizationErrorCommand>
{
    public CreateLogAuthorizationErrorCommandValidator()
    {
