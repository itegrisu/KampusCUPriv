namespace Application.Features.LogManagementFeatures.LogFailedLogins.Constants;

public static class LogFailedLoginsBusinessMessages
{
    public const string SectionName = "LogFailedLogin";

    public const string LogFailedLoginNotExists = "LogFailedLogin Not Exists";
    public const string ProcessCompleted = "Process Completed";

    public const string SuccessCreatedLogFailedLoginMessage = "LogFailedLogin Successfully Created";
    public const string SuccessDeletedLogFailedLoginMessage = "LogFailedLogin Successfully Deleted";
    public const string SuccessUpdatedLogFailedLoginMessage = "LogFailedLogin Successfully Updated";
