...
public class CreateFinanceExpenseDetailCommandValidator : AbstractValidator<CreateFinanceExpenseDetailCommand>
{
    public CreateFinanceExpenseDetailCommandValidator()
    {
