...
{
    public class CreateTransportationServiceWithGroupCommandValidator : AbstractValidator<CreateTransportationServiceWithGroupCommand>
    {
        public CreateTransportationServiceWithGroupCommandValidator()
        {
