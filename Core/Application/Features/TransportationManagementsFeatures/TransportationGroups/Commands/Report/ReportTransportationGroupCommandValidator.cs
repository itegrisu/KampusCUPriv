...
{
    public class ReportTransportationGroupCommandValidator : AbstractValidator<ReportTransportationGroupCommand>
    {
        public ReportTransportationGroupCommandValidator()
        {
