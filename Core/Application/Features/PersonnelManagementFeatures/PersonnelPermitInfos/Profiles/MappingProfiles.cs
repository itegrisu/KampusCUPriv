...
public class MappingProfiles : Profile
{
    public MappingProfiles()
    {
        ...
        CreateMap<X.PersonnelPermitInfo, GetByUserGidListPersonnelPermitInfoListItemDto>().ReverseMap();
        CreateMap<IPaginate<X.PersonnelPermitInfo>, GetListResponse<GetByUserGidListPersonnelPermitInfoListItemDto>>().ReverseMap();
    }
}