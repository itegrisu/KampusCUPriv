...
public class UpdateGuestAccommodationPersonCommandValidator : AbstractValidator<UpdateGuestAccommodationPersonCommand>
{
    public UpdateGuestAccommodationPersonCommandValidator()
    {
