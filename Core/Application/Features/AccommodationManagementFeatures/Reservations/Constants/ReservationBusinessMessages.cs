namespace Application.Features.AccommodationManagementFeatures.Reservations.Constants;

public static class ReservationsBusinessMessages
{
    public const string SectionName = "Reservation";

    public const string ReservationNotExists = "Reservation Not Exists";
    public const string ProcessCompleted = "Process Completed";

    public const string SuccessCreatedReservationMessage = "Reservation Successfully Created";
    public const string SuccessDeletedReservationMessage = "Reservation Successfully Deleted";
    public const string SuccessUpdatedReservationMessage = "Reservation Successfully Updated";
