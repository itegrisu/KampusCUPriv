namespace Application.Features.AccommodationManagementFeatures.Guests.Constants;

public static class GuestsBusinessMessages
{
    public const string SectionName = "Guest";

    public const string GuestNotExists = "Guest Not Exists";
    public const string ProcessCompleted = "Process Completed";

    public const string SuccessCreatedGuestMessage = "Guest Successfully Created";
    public const string SuccessDeletedGuestMessage = "Guest Successfully Deleted";
    public const string SuccessUpdatedGuestMessage = "Guest Successfully Updated";
