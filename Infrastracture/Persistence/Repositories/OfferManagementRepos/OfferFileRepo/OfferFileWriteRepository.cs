...
{
    public class OfferFileWriteRepository : WriteRepository<OfferFile>, IOfferFileWriteRepository
    {
        private readonly Emasist2024Context _context;
        public OfferFileWriteRepository(Emasist2024Context context) : base(context)
        {
            _context = context;
        }
    }
