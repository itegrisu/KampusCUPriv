...
namespace Persistence.Repositories.FinanceManagementRepos.FinanceExpenseGroupRepo
{
    ...
    public class FinanceExpenseGroupReadRepository : ReadRepository<FinanceExpenseGroup>, IFinanceExpenseGroupReadRepository
    {
        private readonly Emasist2024Context _context;
        public FinanceExpenseGroupReadRepository(Emasist2024Context context) : base(context)
        {
            _context = context;
        }
    }
