...
{
    public class TaskCommentWriteRepository : WriteRepository<TaskComment>, ITaskCommentWriteRepository
    {
        private readonly Emasist2024Context _context;
        public TaskCommentWriteRepository(Emasist2024Context context) : base(context)
        {
            _context = context;
        }
    }
